...
public class ApplicationLoader {
     ...
     */
    public static ArrayList<Build> loadBuildsFromDir(File dir) throws FileNotFoundException,IOException {
        ...
        if(fileList == null) throw new IOException("FileList was Null");
